...
import os
work_dir = '/wynton/group/pollen/jding/Sara/data/HumanDev'
...
if not os.path.exists(os.path.join(work_dir, 'scanpy')):
    os.makedirs(os.path.join(work_dir, 'scanpy'))
...
import scanpy as sc
#adata = sc.read('/wynton/group/pollen/sara/20240103_GEX_D40-D100-D80.h5ad')
adata = sc.read('/wynton/group/pollen/sara/20240313_GEX_D40-D100-D80.h5ad')
adata
...
adata.obs['supervised_name'] = [x.replace(",", "") for x in adata.obs['supervised_name']]
adata.obs['supervised_name'] = [x.replace("/", "_") for x in adata.obs['supervised_name']]
adata.obs['supervised_name'] = [x.replace(" ", "_") for x in adata.obs['supervised_name']]
...
adata=adata[adata.obs['individual'].isin(['H9', 'H20961', 'H21194', 'H21792', 'H23555', 'H28126', 'H28834', 'H29089'])]
...
fragments_dict={'D80_M_0-6_CNTRL_Human': '/wynton/group/pollen/sara_bam_d80_221216/D80_M_0-6_CNTRL_Human/outs/atac_fragments.tsv.gz',
 'D80_M_0-8_CNTRL_Human': '/wynton/group/pollen/sara_bam_d80_221216/D80_M_0-8_CNTRL_Human/outs/atac_fragments.tsv.gz',
 'D40_outgroup-exp_1_Human': '/wynton/group/pollen/sara_bam_230211_outgroup/D40_outgroup-exp_1_Human/outs/atac_fragments.tsv.gz',
 'D40_outgroup-exp_2_Human': '/wynton/group/pollen/sara_bam_230211_outgroup/D40_outgroup-exp_2_Human/outs/atac_fragments.tsv.gz',
 'D80_M_0-8_CNTRL-2_Human': '/wynton/group/pollen/sara_bam_230211_outgroup/D80_M_0-8_CNTRL-2_Human/outs/atac_fragments.tsv.gz',
 'D80_M_0-8_CNTRL-3_Human': '/wynton/group/pollen/sara_bam_230211_outgroup/D80_M_0-8_CNTRL-3_Human/outs/atac_fragments.tsv.gz',
 'D80_outgroup-exp_1_Human': '/wynton/group/pollen/sara_bam_230211_outgroup/D80_outgroup-exp_1_Human/outs/atac_fragments.tsv.gz',
 'D80_outgroup-exp_2_Human': '/wynton/group/pollen/sara_bam_230211_outgroup/D80_outgroup-exp_2_Human/outs/atac_fragments.tsv.gz',
 'D80_outgroup-exp_3_Human': '/wynton/group/pollen/sara_bam_230211_outgroup/D80_outgroup-exp_3_Human/outs/atac_fragments.tsv.gz',
 'D40_CH_1_Human': '/wynton/group/pollen/sara_bam_timepoint2_220317/D40_CH_1_Human/outs/atac_fragments.tsv.gz',
 'D40_CH_2_Human': '/wynton/group/pollen/sara_bam_timepoint2_220317/D40_CH_2_Human/outs/atac_fragments.tsv.gz',
 'D40_CH_3_Human': '/wynton/group/pollen/sara_bam_timepoint2_220317/D40_CH_3_Human/outs/atac_fragments.tsv.gz',
 'D40_M0-5_1_Human': '/wynton/group/pollen/sara_bam_timepoint2_220317/D40_M0-5_1_Human/outs/atac_fragments.tsv.gz',
 'D40_M0-5_2_Human': '/wynton/group/pollen/sara_bam_timepoint2_220317/D40_M0-5_2_Human/outs/atac_fragments.tsv.gz',
 'D40_M_1_Human': '/wynton/group/pollen/sara_bam_timepoint2_220317/D40_M_1_Human/outs/atac_fragments.tsv.gz',
 'D40_M_2_Human': '/wynton/group/pollen/sara_bam_timepoint2_220317/D40_M_2_Human/outs/atac_fragments.tsv.gz',
 'D40_M_3_Human': '/wynton/group/pollen/sara_bam_timepoint2_220317/D40_M_3_Human/outs/atac_fragments.tsv.gz',
 'D100_M_0-4_Human': '/wynton/group/pollen/sara_bam_timepoint3_220405/D100_M_0-4_Human/outs/atac_fragments.tsv.gz',
 'D100_M_0-5_Human': '/wynton/group/pollen/sara_bam_timepoint3_220405/D100_M_0-5_Human/outs/atac_fragments.tsv.gz',
 'D100_M_0-6_Human': '/wynton/group/pollen/sara_bam_timepoint3_220405/D100_M_0-6_Human/outs/atac_fragments.tsv.gz',
 'D100_M_0-8_Human': '/wynton/group/pollen/sara_bam_timepoint3_220405/D100_M_0-8_Human/outs/atac_fragments.tsv.gz'}
...
cell_data.index = [x.split('-')[0] + '-1' for x in cell_data.index]
cell_data
...
chromsizes=pd.read_csv('/wynton/home/pollenlab/jding/hg38.chrom.sizes', sep='\t', header=None)
...
bw_paths, bed_paths = export_pseudobulk(input_data = cell_data,
                 variable = variable,                                                                     # variable by which to generate pseubulk profiles, in this case we want pseudobulks per celltype
...
path_to_regions={'D80_M_0-6_CNTRL_Human': '/wynton/group/pollen/jding/Sara/data/HumanDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D80_M_0-8_CNTRL_Human': '/wynton/group/pollen/jding/Sara/data/HumanDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D40_outgroup-exp_1_Human': '/wynton/group/pollen/jding/Sara/data/HumanDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D40_outgroup-exp_2_Human': '/wynton/group/pollen/jding/Sara/data/HumanDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D80_M_0-8_CNTRL-2_Human': '/wynton/group/pollen/jding/Sara/data/HumanDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D80_M_0-8_CNTRL-3_Human': '/wynton/group/pollen/jding/Sara/data/HumanDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D80_outgroup-exp_1_Human': '/wynton/group/pollen/jding/Sara/data/HumanDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D80_outgroup-exp_2_Human': '/wynton/group/pollen/jding/Sara/data/HumanDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D80_outgroup-exp_3_Human': '/wynton/group/pollen/jding/Sara/data/HumanDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D40_CH_1_Human': '/wynton/group/pollen/jding/Sara/data/HumanDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D40_CH_2_Human': '/wynton/group/pollen/jding/Sara/data/HumanDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D40_CH_3_Human': '/wynton/group/pollen/jding/Sara/data/HumanDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D40_M0-5_1_Human': '/wynton/group/pollen/jding/Sara/data/HumanDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D40_M0-5_2_Human': '/wynton/group/pollen/jding/Sara/data/HumanDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D40_M_1_Human': '/wynton/group/pollen/jding/Sara/data/HumanDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D40_M_2_Human': '/wynton/group/pollen/jding/Sara/data/HumanDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D40_M_3_Human': '/wynton/group/pollen/jding/Sara/data/HumanDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D100_M_0-4_Human': '/wynton/group/pollen/jding/Sara/data/HumanDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D100_M_0-5_Human': '/wynton/group/pollen/jding/Sara/data/HumanDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D100_M_0-6_Human': '/wynton/group/pollen/jding/Sara/data/HumanDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D100_M_0-8_Human': '/wynton/group/pollen/jding/Sara/data/HumanDev/scATAC/consensus_peak_calling/consensus_regions.bed'}
...
qc_filters={'D40_outgroup-exp_1_Human': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D40_outgroup-exp_2_Human': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D80_M_0-6_CNTRL_Human': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D80_M_0-8_CNTRL_Human': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D80_M_0-8_CNTRL-2_Human': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D80_M_0-8_CNTRL-3_Human': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D80_outgroup-exp_1_Human': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D80_outgroup-exp_2_Human': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D80_outgroup-exp_3_Human': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D40_CH_1_Human': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D40_CH_2_Human': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D40_CH_3_Human': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D40_M0-5_1_Human': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D40_M0-5_2_Human': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D40_M_1_Human': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D40_M_2_Human': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D40_M_3_Human': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D100_M_0-4_Human': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D100_M_0-5_Human': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D100_M_0-6_Human': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D100_M_0-8_Human': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]}}
...
cell_data['barcode'] = cell_data.index.astype(str) +'___'+ cell_data['batch_name'].astype(str)
print(cell_data['barcode'][0:5])
cell_data = cell_data.set_index('barcode')
for x in cell_data.columns.tolist():
    cistopic_obj.add_cell_data(cell_data[[x]])

# In[85]:


#remove cells not in scRNA-seq
...
markers_dict = find_diff_features(cistopic_obj, imputed_acc_obj, variable=variable, var_features=variable_regions, split_pattern = '-')
...
fpath = "/wynton/group/pollen/jding/Sara/data/HumanDev/scATAC/"
motif_fpath = '/wynton/group/pollen/jding/cisTarget/'


# In[55]:


rankings_db = os.path.join(fpath, 'consensus_peak_calling.regions_vs_motifs.rankings.feather')
scores_db =  os.path.join(fpath, 'consensus_peak_calling.regions_vs_motifs.scores.feather')
motif_annotation = os.path.join(motif_fpath, 'motifs-v10nr_clust-nr.hgnc-m0.001-o0.0.tbl')
...
tmp_dir = '/scratch/leuven/330/vsc33053/'
#require internet connection #cannot su
run_pycistarget(
...
#get_ipython().system('wget -O /wynton/home/pollenlab/jding/scenicplus/HumanCtx/data/utoronto_human_tfs_v_1.01.txt  http://humantfs.ccbr.utoronto.ca/download/v_1.01/TF_names_v_1.01.txt')
...
#get_ipython().system('wget -O /wynton/home/pollenlab/jding/scenicplus/bedToBigBed http://hgdownload.soe.ucsc.edu/admin/exe/linux.x86_64/bedToBigBed')
#get_ipython().system('chmod +x /wynton/home/pollenlab/jding/scenicplus/bedToBigBed')
...
plot_metadata_given_ax(
    ...
    variable = 'GEX_supervised_name', #note the GEX_ prefix, this metadata originated from the gene expression metadata (on which we did the cell type annotation before)
...
scplus_obj.metadata_cell['GEX_supervised_name'].unique()
...
heatmap_dotplot(
        ...
        group_variable = 'GEX_supervised_name',
        subset_eRegulons = scplus_obj.uns['eRegulon_metadata_filtered'].Gene_signature_name.unique(),
       index_order = [ 'DA_neurons','DA_STN_neurons_immature','STN_neurons', 
                        'MB_glutamatergic_neurons','MB_HB_glutamatergic_neurons',
                       'MB_HB_glutamatergic_neurons_immature','MB_HB_neurons_LHX1+',
                       'Oculomotor_neurons','MB_GABAergic_neurons','Hypothalamic_neurons',
                       'Ventral_FB_MB_progenitors','Ventral_FB_MB_progenitors_cycling', 'FB_progenitors',
                       'Lateral_MB_progenitors','Lateral_MB_progenitors_cycling','Progenitors_cycling',
                       'MB_HB_FP_cells', 'Glial_progenitors_astrocytes', 'Low_quality_technical'][::-1],
        figsize = (25, 10),
        orientation = 'horizontal',
        save='/wynton/home/pollenlab/jding/Sara/scenicplus/figures/scenicplus/HumanDev_heatmap.pdf')

print(scplus_obj.uns['eRegulon_metadata']['TF'].unique())


chimp=['ARNT', 'ARX', 'ASCL1', 'ATF4', 'ATF6' ,'BACH2' ,'BATF3', 'BBX' ,'BHLHE41', 
'CLOCK', 'CREB5', 'CUX1', 'CUX2', 'E2F1', 'E2F2' ,'E2F3' ,'E2F7' ,'EBF1' ,'EBF3',
 'ELF2', 'ELK3' ,'EN1', 'EN2', 'ETV1', 'FOXA1' ,'FOXK2' ,'FOXM1', 'FOXN4' ,'FOXP1',
 'FOXP2', 'HBP1', 'HES1', 'HES5', 'HMGA2', 'HNF4G' ,'ISL1', 'JUND', 'KLF12', 'KLF7',
 'LHX9', 'LIN28B', 'LMX1A', 'MBD2', 'MEF2A' ,'MEIS1' ,'MTF2' ,'MXD3', 'MXI1',
 'MYBL2', 'NFE2L1', 'NFE2L2', 'NFIA', 'NFIB', 'NFIC', 'NR2C2', 'NR2F1' ,'ONECUT1',
 'ONECUT2', 'ONECUT3', 'OTX2', 'PAX3', 'PAX7' ,'PBX1' ,'PBX3' ,'POU2F1', 'POU2F2',
 'POU3F2', 'POU3F3', 'POU6F2', 'PRRX1', 'PURA', 'RFX3', 'RFX4', 'SKI' ,'SMAD1',
 'SMAD3', 'SOX2', 'SOX4', 'SOX5' ,'SREBF2', 'STAT1' ,'TCF12' ,'TCF7L1' ,'TEAD1',
 'TFDP2', 'TLX3', 'UNCX', 'YY1', 'ZBTB16', 'ZBTB18', 'ZBTB20' ,'ZEB1' ,'ZEB2',
 'ZFHX3', 'ZIC1', 'ZIC3', 'ZNF24', 'ZNF519', 'ZNF682' ,'ZNF770' ,'CDC5L', 'CREB1',
 'CTCF', 'DEAF1', 'DRAP1', 'FOXJ3', 'FOXN2', 'HMBOX1', 'JUN', 'LMX1B', 'MAX' ,'MGA',
 'NFYC', 'NRF1', 'PHF20', 'PKNOX1' ,'RFX2', 'RFX7' 'SOX11' 'SOX6' 'STAT2',
 'TCF7L2', 'YBX1', 'ZBTB11', 'ZBTB25', 'ZBTB43' ,'ZNF148' ,'ZNF217' ,'ZNF37A',
 'ZNF44', 'ZNF518A', 'ZNF565', 'ZNF652', 'ZNF706', 'ZNF891' ,'ZSCAN30' ,'TCF4',
 'BARHL2', 'CREB3L2', 'GLI3', 'GTF2IRD1', 'HES4', 'HES6' ,'HSF1' ,'KLF3', 'KMT2A',
 'LCORL', 'MEF2C', 'NCOA1' ,'NR2F6', 'NR4A2' ,'OTP' ,'PKNOX2' ,'RBPJ' ,'REST',
 'TCF3', 'TFAP2B', 'VEZF1' ,'ZIC2', 'ZNF274','ZNF367' ,'ZSCAN18' ,'AHDC1' ,'ATF2',
 'BPTF', 'CREB3', 'KLF6' ,'NCOA2', 'NCOA3' ,'NFAT5', 'PHF21A', 'PRDM5' ,'SETBP1',
 'SMAD9', 'SOX12', 'STAT3', 'STAT5B', 'TGIF1', 'ZNF131', 'ZNF333', 'ZNF432']
overlap = [x for x in chimp if x in scplus_obj.uns['eRegulon_metadata']['TF'].unique()]
overlap

eRegulon = [x for x in scplus_obj.uns['eRegulon_metadata_filtered'].Region_signature_name.unique() if x.split('_')[0] in overlap]
heatmap_dotplot(
        scplus_obj = scplus_obj,
        size_matrix = scplus_obj.uns['eRegulon_AUC_filtered']['Region_based'], #specify what to plot as dot sizes, target region enrichment in this case
        color_matrix = scplus_obj.to_df('EXP'), #specify  what to plot as colors, TF expression in this case
        ...
        figsize = (20, 10),
        orientation = 'horizontal',
        save='/wynton/home/pollenlab/jding/Sara/scenicplus/figures/scenicplus/HumanDev_heatmap_overlap.pdf')

#gene-based
scplus_obj.uns['TF2G_adj'].to_csv(os.path.join(work_dir, 'scenicplus/TF2G_adj_all.csv'))
import pandas as pd
values = [x.split('_')[-1][1:-2] for x in scplus_obj.uns['eRegulon_signatures_filtered']['Gene_based'].keys() if x.split('_')[1] == '+']
keys = [x.split('_')[0] for x in scplus_obj.uns['eRegulon_signatures_filtered']['Gene_based'].keys() if x.split('_')[1] == '+']
map = pd.DataFrame({'TF': keys, 'genes':values})
map.to_csv(os.path.join(work_dir, 'scenicplus/GRN_signatures.csv'))
map.head()
...
for x in scplus_obj.uns['eRegulon_signatures_filtered']['Gene_based']:
    name= x.replace('(','')
    name= name.replace(')','')
    file = open(os.path.join(work_dir, 'scenicplus/GRNs',name+'.txt'),'w')
...
#region-based
import pandas as pd
values = [x.split('_')[-1][1:-2] for x in scplus_obj.uns['eRegulon_signatures_filtered']['Region_based'].keys() if x.split('_')[1] == '+']
keys = [x.split('_')[0] for x in scplus_obj.uns['eRegulon_signatures_filtered']['Region_based'].keys() if x.split('_')[1] == '+']
map = pd.DataFrame({'TF': keys, 'regions':values})
...
keys = [x.split('_')[0] for x in scplus_obj.uns['eRegulon_signatures_filtered']['Region_based'].keys() if x.split('_')[1] == '+']
df = scplus_obj.uns['region_to_gene']
df = df[df['TF'].isin(keys)]
df = df[df['target'].isin(keys)]
df.to_csv(os.path.join(work_dir, 'scenicplus/R2G_adj.csv'))
df.head()
...
regulon_specificity_scores(
        ...
        selected_regulons = [x for x in scplus_obj.uns['eRegulon_metadata_filtered']['Region_signature_name'].unique() if '-' not in x],
...
regulon_specificity_scores(
        ...
        selected_regulons = [x for x in scplus_obj.uns['eRegulon_metadata_filtered']['Gene_signature_name'].unique() if '-' not in x],
        out_key_suffix = '_filtered')
...
#plot_rss(scplus_obj, 'GEX_supervised_name_filtered', num_columns=3, top_n=20, figsize = (15, 30),save='/wynton/home/pollenlab/jding/Sara/scenicplus/figures/scenicplus/HumanDev_rss.pdf')
...
selected_markers = list(set(flat_list(
    [scplus_obj.uns['RSS']['GEX_cell_type_filtered'].loc[celltype].sort_values(ascending = False).head(10).index.to_list() 
    for celltype in scplus_obj.uns['RSS']['GEX_cell_type_filtered'].index])))
...
hvr = find_highly_variable_features(scplus_obj.to_df('ACC').loc[list(set(scplus_obj.uns['eRegulon_metadata_filtered']['Region']))], n_top_features=4500, plot = False)
hvg = find_highly_variable_features(scplus_obj.to_df('EXP')[list(set(scplus_obj.uns['eRegulon_metadata_filtered']['Gene']))].T, n_top_features=4500, plot = False)
...
genes = ['OTX2', 'LMX1A','PBX1','LIN28B','PRRX1']
...
nx_tables = create_nx_tables(
    ...
    differential_variable = ['ACC_supervised_name']
)
...
G, pos, edge_tables, node_tables = create_nx_graph(nx_tables, 
                   ...
                   color_node_by = {'TF': {'variable': 'TF', 'category_color' : {genes[0]: 'Orange', 
                                    ...
                                    'Gene': {'variable': 'ACC_supervised_name_Log2FC_DA_neurons', 'continuous_color' : 'bwr'},
                                    'Region': {'variable': 'ACC_supervised_name_Log2FC_DA_neurons', 'continuous_color' : 'viridis'}},
                   transparency_node_by =  {'Region': {'variable' : 'ACC_supervised_name_Log2FC_DA_neurons', 'min_alpha': 0.1},
                                    'Gene': {'variable' : 'ACC_supervised_name_Log2FC_DA_neurons', 'min_alpha': 0.1}},
                   ...
                   label_size_by = {'TF': {'variable': 'fixed_label_size', 'fixed_label_size': 30.0},
                                    'Gene': {'variable': 'fixed_label_size', 'fixed_label_size': 14.0},
...
export_to_cytoscape(G, pos, out_file = os.path.join(work_dir, 'scenicplus/network.cys'))
...
'''
# ### Export TF information to scanpy
