...
import os
work_dir = '/wynton/group/pollen/jding/Sara/data/MacaqueD16'
...
import scanpy as sc
#adata = sc.read('/wynton/group/pollen/sara/20240103_GEX_D16_cells_annotation.h5ad')
adata = sc.read('/wynton/group/pollen/sara/20240221_GEX_all_D16_cells_annotation.h5ad')
print(adata)


# In[6]:

adata.obs['supervised_name'] = adata.obs['cell_type']
...
print(adata.X)
print(adata.obs['batch_name'].unique())
...
fragments_dict={'D16_outgroup-exp_Rhesus': '/wynton/scratch/new_bams_sara/D16_outgroup-exp_Rhesus/outs/atac_fragments.tsv.gz',
 'D16_M0_5_Rhesus': '/wynton/scratch/new_bams_sara/M0_5_Rhesus/outs/atac_fragments.tsv.gz',
 'D16_M2_Rhesus': '/wynton/scratch/new_bams_sara/M2_Rhesus/outs/atac_fragments.tsv.gz',
 'D16_M_Rhesus': '/wynton/scratch/new_bams_sara/M_Rhesus/outs/atac_fragments.tsv.gz'}
...
genome = '/wynton/group/pollen/genomes/cellranger-arc/Rhesus_chrMliftoff_numtmask_arc'
...
# Other param
peak_half_width = 250
path_to_blacklist= '/wynton/group/pollen/nathan/blacklists/rheMac10_blacklist_LEGIT.bed'
# Get consensus peaks
...
import pandas as pd
transcripts ='/wynton/group/pollen/genomes/cellranger-arc/Rhesus_chrMliftoff_numtmask_arc/regions/transcripts.bed'
...
geneInfo ='/wynton/group/pollen/genomes/cellranger-arc/Rhesus_chrMliftoff_numtmask_arc/star/geneInfo.tab'
...
path_to_regions={'D16_CH2_Chimp': '/wynton/group/pollen/jding/Sara/data/ChimpD16/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D16_CH_Chimp': '/wynton/group/pollen/jding/Sara/data/ChimpD16/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D16_M0_5_Chimp': '/wynton/group/pollen/jding/Sara/data/ChimpD16/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D16_M2_Chimp': '/wynton/group/pollen/jding/Sara/data/ChimpD16/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D16_M_Chimp': '/wynton/group/pollen/jding/Sara/data/ChimpD16/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D16_outgroup-exp_Chimp': '/wynton/group/pollen/jding/Sara/data/ChimpD16/scATAC/consensus_peak_calling/consensus_regions.bed'}
...
qc_filters={'D16_CH2_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D16_CH_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D16_M0_5_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D16_M2_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D16_M_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D16_outgroup-exp_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]}}
...
import pickle
import os
work_dir = '/wynton/group/pollen/jding/Sara/data/ChimpD16'
...
fragments_dict={'D16_CH2_Chimp': '/wynton/group/pollen/sara_bam_timepoint1/CH2_Chimp/outs/atac_fragments.tsv.gz',
 'D16_CH_Chimp': '/wynton/group/pollen/sara_bam_timepoint1/CH_Chimp/outs/atac_fragments.tsv.gz',
 'D16_M0_5_Chimp': '/wynton/group/pollen/sara_bam_timepoint1/M0_5_Chimp/outs/atac_fragments.tsv.gz',
 'D16_M2_Chimp': '/wynton/group/pollen/sara_bam_timepoint1/M2_Chimp/outs/atac_fragments.tsv.gz',
 'D16_M_Chimp': '/wynton/group/pollen/sara_bam_timepoint1/M_Chimp/outs/atac_fragments.tsv.gz',
 'D16_outgroup-exp_Chimp': '/wynton/group/pollen/sara_bam_230211_outgroup/D16_outgroup-exp_Chimp/outs/atac_fragments.tsv.gz'}
...
fpath = "/wynton/group/pollen/jding/Sara/data/ChimpD16/scATAC/"
...
import pyranges as pr
dataset = pbm.Dataset(name='ptroglodytes_gene_ensembl',  host='http://www.ensembl.org')
...
#plt.save('/wynton/home/pollenlab/jding/Sara/scenicplus/figures/scenicplus/ChimpD16_selection.pdf')
plt.show()
...
heatmap_dotplot(
        ...
        save='/wynton/home/pollenlab/jding/Sara/scenicplus/figures/scenicplus/ChimpD16_heatmap.pdf')


human=['ADNP', 'ARID5B', 'ARX', 'ATF2', 'ATF7', 'BACH2', 'BNC2', 'BPTF',
       'CREB5', 'CREM', 'DRAP1', 'E2F7', 'E2F8', 'EBF1', 'EBF3', 'ELF2',
       'ELK3', 'EN1', 'ETS1', 'ETV1', 'ETV5', 'ETV6', 'FLI1', 'FOSL1',
       'FOXA1', 'FOXA2', 'FOXB1', 'FOXC2', 'FOXM1', 'FOXN3', 'FOXP1',
       'FOXP2', 'GLI3', 'HBP1', 'HES1', 'HIF1A', 'HMGA1', 'HMGA2',
       'IKZF2', 'ISL1', 'JUN', 'JUNB', 'JUND', 'LCORL', 'LEF1', 'LIN28B',
       'LMX1A', 'LMX1B', 'MEIS1', 'MEIS2', 'MTF2', 'MXD3', 'MYBL1',
       'MYBL2', 'NFATC3', 'NFE2L1', 'NFE2L2', 'NFIA', 'NFXL1', 'NFYC',
       'NKX2-1', 'NKX6-1', 'NR2C1', 'NR2F1', 'NR2F2', 'ONECUT2',
       'ONECUT3', 'OTX2', 'PAX5', 'PAX8', 'PBX1', 'PBX3', 'PHOX2A',
       'PHOX2B', 'PKNOX2', 'PLAGL1', 'POU3F2', 'POU6F2', 'PRRX1', 'RFX2',
       'RFX3', 'RFX4', 'SMAD4', 'SOX11', 'SOX2', 'SOX4', 'SOX5', 'SOX6',
       'SP3', 'SREBF2', 'STAT5B', 'TCF12', 'TCF3', 'TCF4', 'TCF7L1',
       'TCF7L2', 'TEAD1', 'TFDP2', 'UNCX', 'VEZF1', 'VSX1', 'YBX1',
       'ZBTB18', 'ZBTB20', 'ZEB1', 'ZNF100', 'ZNF141', 'ZNF280D',
       'ZNF281', 'ZNF423', 'ZNF496', 'ZNF519', 'ZNF580', 'ZNF682',
       'ZNF704', 'ZNF730', 'ZNF90', 'ZNF93', 'ARID3A', 'BBX', 'CREB3L1',
       'CTCF', 'CUX1', 'FOXO1', 'FOXO3', 'KLF12', 'KLF3', 'KLF6', 'MAZ',
       'MEF2A', 'RFX7', 'ZEB2', 'ZNF518A', 'ZNF680', 'ARID3B', 'DNMT1',
       'FOXK2', 'GLI2', 'HDX', 'HMBOX1', 'KMT2A', 'LHX1', 'NEUROD4',
       'NFIB', 'NR2F6', 'RELA', 'RORA', 'SKI', 'SMAD1', 'TGIF2', 'TP53',
       'TRPS1', 'ZFHX3', 'ZNF217', 'ZNF367', 'ZNF462', 'CREB3L2', 'FOXK1',
       'GLIS3', 'IKZF1', 'LHX4', 'NR2C2', 'SETBP1', 'TFDP1', 'YY1',
       'ZNF107', 'ZNF131', 'ZNF644']
...
heatmap_dotplot(
        ...
        figsize = (10, 20),
        orientation = 'vertical',
        save='/wynton/home/pollenlab/jding/Sara/scenicplus/figures/scenicplus/ChimpD16_heatmap_overlap.pdf')
...
plot_rss(scplus_obj, 'GEX_supervised_name_filtered', num_columns=3, top_n=20, figsize = (15, 30),save='/wynton/home/pollenlab/jding/Sara/scenicplus/figures/scenicplus/ChimpD16_rss.pdf')
...
scplus_obj.uns['RSS']['GEX_supervised_name_filtered'].to_csv(os.path.join(work_dir, 'scenicplus/RSS.csv'))
...
region_intersetc_data, Z = jaccard_heatmap(
        ...
        save='/wynton/home/pollenlab/jding/Sara/scenicplus/figures/scenicplus/ChimpD16_intersect.pdf')
