...
import os
work_dir = '/wynton/group/pollen/jding/Sara/data/ChimpDev'
...
adata = adata[adata.obs['species'] == 'chimp']


# In[11]:


adata = adata[adata.obs['individual'].isin(['C3651', 'C8861', 'C3624', 'C4933', 'C40670', 'C40300', 'C40210'])]
...
fragments_dict={'D80_M_0-6_CNTRL_Chimp': '/wynton/group/pollen/sara_bam_d80_221216/D80_M_0-6_CNTRL_Chimp/outs/atac_fragments.tsv.gz',
 'D80_M_0-8_CNTRL_Chimp': '/wynton/group/pollen/sara_bam_d80_221216/D80_M_0-8_CNTRL_Chimp/outs/atac_fragments.tsv.gz',
 'D40_outgroup-exp_1_Chimp': '/wynton/group/pollen/sara_bam_230211_outgroup/D40_outgroup-exp_1_Chimp/outs/atac_fragments.tsv.gz',
 'D40_outgroup-exp_2_Chimp': '/wynton/group/pollen/sara_bam_230211_outgroup/D40_outgroup-exp_2_Chimp/outs/atac_fragments.tsv.gz',
 'D80_M_0-8_CNTRL-2_Chimp': '/wynton/group/pollen/sara_bam_230211_outgroup/D80_M_0-8_CNTRL-2_Chimp/outs/atac_fragments.tsv.gz',
 'D80_M_0-8_CNTRL-3_Chimp': '/wynton/group/pollen/sara_bam_230211_outgroup/D80_M_0-8_CNTRL-3_Chimp/outs/atac_fragments.tsv.gz',
 'D80_outgroup-exp_1_Chimp': '/wynton/group/pollen/sara_bam_230211_outgroup/D80_outgroup-exp_1_Chimp/outs/atac_fragments.tsv.gz',
 'D80_outgroup-exp_2_Chimp': '/wynton/group/pollen/sara_bam_230211_outgroup/D80_outgroup-exp_2_Chimp/outs/atac_fragments.tsv.gz',
 'D80_outgroup-exp_3_Chimp': '/wynton/group/pollen/sara_bam_230211_outgroup/D80_outgroup-exp_3_Chimp/outs/atac_fragments.tsv.gz',
 'D40_CH_1_Chimp': '/wynton/group/pollen/sara_bam_timepoint2_220317/D40_CH_1_Chimp/outs/atac_fragments.tsv.gz',
 'D40_CH_2_Chimp': '/wynton/group/pollen/sara_bam_timepoint2_220317/D40_CH_2_Chimp/outs/atac_fragments.tsv.gz',
 'D40_CH_3_Chimp': '/wynton/group/pollen/sara_bam_timepoint2_220317/D40_CH_3_Chimp/outs/atac_fragments.tsv.gz',
 'D40_M0-5_1_Chimp': '/wynton/group/pollen/sara_bam_timepoint2_220317/D40_M0-5_1_Chimp/outs/atac_fragments.tsv.gz',
 'D40_M0-5_2_Chimp': '/wynton/group/pollen/sara_bam_timepoint2_220317/D40_M0-5_2_Chimp/outs/atac_fragments.tsv.gz',
 'D40_M_1_Chimp': '/wynton/group/pollen/sara_bam_timepoint2_220317/D40_M_1_Chimp/outs/atac_fragments.tsv.gz',
 'D40_M_2_Chimp': '/wynton/group/pollen/sara_bam_timepoint2_220317/D40_M_2_Chimp/outs/atac_fragments.tsv.gz',
 'D40_M_3_Chimp': '/wynton/group/pollen/sara_bam_timepoint2_220317/D40_M_3_Chimp/outs/atac_fragments.tsv.gz',
 'D100_M_0-4_Chimp': '/wynton/group/pollen/sara_bam_timepoint3_220405/D100_M_0-4_Chimp/outs/atac_fragments.tsv.gz',
 'D100_M_0-5_Chimp': '/wynton/group/pollen/sara_bam_timepoint3_220405/D100_M_0-5_Chimp/outs/atac_fragments.tsv.gz',
 'D100_M_0-6_Chimp': '/wynton/group/pollen/sara_bam_timepoint3_220405/D100_M_0-6_Chimp/outs/atac_fragments.tsv.gz',
 'D100_M_0-8_Chimp': '/wynton/group/pollen/sara_bam_timepoint3_220405/D100_M_0-8_Chimp/outs/atac_fragments.tsv.gz'}
...
# Get chromosome sizes (for chimp here)
# Using cellranger-arc reference
import pyranges as pr
import requests
import pandas as pd

genome = '/wynton/group/pollen/genomes/cellranger-arc/Chimp_chrMliftoff_numtmask_arc'

chromsizes=pd.read_csv(os.path.join(genome,'star/chrNameLength.txt'), sep='\t', header=None)
...
# Use blacklist from Nathan
from pycisTopic.iterative_peak_calling import *
# Other param
peak_half_width = 250
path_to_blacklist= '/wynton/group/pollen/nathan/blacklists/chimp/Chimp_hal_blacklist_merged.bed'
# Get consensus peaks
...
import pandas as pd
transcripts ='/wynton/group/pollen/genomes/cellranger-arc/Chimp_chrMliftoff_numtmask_arc/regions/transcripts.bed'
...
geneInfo ='/wynton/group/pollen/genomes/cellranger-arc/Chimp_chrMliftoff_numtmask_arc/star/geneInfo.tab'
...
path_to_regions={'D80_M_0-6_CNTRL_Chimp': '/wynton/group/pollen/jding/Sara/data/ChimpDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D80_M_0-8_CNTRL_Chimp': '/wynton/group/pollen/jding/Sara/data/ChimpDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D40_outgroup-exp_1_Chimp': '/wynton/group/pollen/jding/Sara/data/ChimpDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D40_outgroup-exp_2_Chimp': '/wynton/group/pollen/jding/Sara/data/ChimpDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D80_M_0-8_CNTRL-2_Chimp': '/wynton/group/pollen/jding/Sara/data/ChimpDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D80_M_0-8_CNTRL-3_Chimp': '/wynton/group/pollen/jding/Sara/data/ChimpDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D80_outgroup-exp_1_Chimp': '/wynton/group/pollen/jding/Sara/data/ChimpDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D80_outgroup-exp_2_Chimp': '/wynton/group/pollen/jding/Sara/data/ChimpDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D80_outgroup-exp_3_Chimp': '/wynton/group/pollen/jding/Sara/data/ChimpDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D40_CH_1_Chimp': '/wynton/group/pollen/jding/Sara/data/ChimpDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D40_CH_2_Chimp': '/wynton/group/pollen/jding/Sara/data/ChimpDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D40_CH_3_Chimp': '/wynton/group/pollen/jding/Sara/data/ChimpDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D40_M0-5_1_Chimp': '/wynton/group/pollen/jding/Sara/data/ChimpDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D40_M0-5_2_Chimp': '/wynton/group/pollen/jding/Sara/data/ChimpDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D40_M_1_Chimp': '/wynton/group/pollen/jding/Sara/data/ChimpDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D40_M_2_Chimp': '/wynton/group/pollen/jding/Sara/data/ChimpDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D40_M_3_Chimp': '/wynton/group/pollen/jding/Sara/data/ChimpDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D100_M_0-4_Chimp': '/wynton/group/pollen/jding/Sara/data/ChimpDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D100_M_0-5_Chimp': '/wynton/group/pollen/jding/Sara/data/ChimpDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D100_M_0-6_Chimp': '/wynton/group/pollen/jding/Sara/data/ChimpDev/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D100_M_0-8_Chimp': '/wynton/group/pollen/jding/Sara/data/ChimpDev/scATAC/consensus_peak_calling/consensus_regions.bed'}
...
qc_filters={'D40_outgroup-exp_1_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D40_outgroup-exp_2_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D80_M_0-6_CNTRL_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D80_M_0-8_CNTRL_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D80_M_0-8_CNTRL-2_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D80_M_0-8_CNTRL-3_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D80_outgroup-exp_1_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D80_outgroup-exp_2_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D80_outgroup-exp_3_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D40_CH_1_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D40_CH_2_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D40_CH_3_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D40_M0-5_1_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D40_M0-5_2_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D40_M_1_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D40_M_2_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D40_M_3_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D100_M_0-4_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D100_M_0-5_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D100_M_0-6_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D100_M_0-8_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]}}
...
fpath = "/wynton/group/pollen/jding/Sara/data/ChimpDev/scATAC/"
...
import pandas as pd
import pyranges as pr
f_fasta_index = '/wynton/group/pollen/genomes/cellranger-arc/Chimp_chrMliftoff_numtmask_arc/fasta/genome.fa.fai' #provde the path to the fasta index file, often this file is named simething like: genome.fa.fai
...
print(scplus_obj.uns['eRegulon_metadata_filtered'].head())
...
#plt.save('/wynton/home/pollenlab/jding/Sara/scenicplus/figures/scenicplus/ChimpDev_selection.pdf')
plt.show()
...
heatmap_dotplot(
        ...
        save='/wynton/home/pollenlab/jding/Sara/scenicplus/figures/scenicplus/ChimpDev_heatmap.pdf')

print(scplus_obj.uns['eRegulon_metadata']['TF'].unique())


human=['CREB5', 'CUX2', 'DDIT3', 'E2F1', 'E2F2' ,'E2F3', 'E2F7', 'EBF1', 'ETV5', 'FOSL1',
 'FOXA1', 'FOXM1', 'FOXP1' ,'GABPA' ,'HMGA2', 'HOXD4' ,'KLF7', 'LHX1', 'LIN28B',
 'LMX1A', 'MAFG', 'MAX', 'MEIS1', 'MEIS2' ,'MGA' ,'MYBL1', 'MYBL2', 'NFATC2',
 'NFE2L1', 'NFIA', 'NFIB' ,'NR2F2' ,'ONECUT1' ,'ONECUT2' ,'ONECUT3' ,'OTX2',
 'PAX3', 'PAX7', 'PBX1', 'PBX3', 'PHOX2B' ,'POU2F2' ,'POU3F3' ,'PRRX1', 'RFX2',
 'RFX3', 'RFX4', 'SOX2', 'SOX5', 'SOX6', 'SOX9', 'SREBF2' ,'STAT3' ,'TCF12', 'TCF4',
 'TCF7L1', 'TCF7L2', 'TEAD1', 'TFDP2' ,'UNCX', 'ZEB1', 'ZFHX3', 'ZIC1' ,'ZNF496',
 'ZNF770', 'ZNF90', 'BHLHE41' ,'BNC2', 'BPTF', 'CLOCK', 'CREB1', 'CREB3L2',
 'DEAF1', 'DRAP1', 'EBF3', 'FOXJ3', 'FOXK1' ,'GTF2IRD1' ,'HOXD3', 'JDP2' ,'JUND',
 'KAT7', 'KLF13', 'LCORL', 'MEF2A', 'MTF2' ,'NFYB' ,'PHF20','RFX7', 'SOX11',
 'SOX4', 'TGIF1', 'THRA', 'YBX1' ,'ZBTB11' ,'ZBTB20', 'ZNF141', 'ZNF148', 'ZNF207',
 'ZNF337', 'ZNF518A', 'ZNF629', 'ZEB2' ,'ATF7' ,'BBX' ,'ESRRG', 'FOXF1', 'FOXP2',
 'GLI3', 'HES1', 'HMGA1', 'IRF2', 'IRF3' ,'MXD3' ,'MXD4' ,'MXI1', 'NCOA1' ,'NFE2L2',
 'NFE2L3', 'NR4A2', 'SKI', 'TFAP2B' ,'ZBTB18', 'ZBTB7A', 'ZNF367', 'ZXDC' ,'CEBPG',
 'CREB3', 'NPAS2', 'REL', 'RORA' ,'SMAD3' ,'STAT2' ,'STAT5B', 'TCF3' ,'ZBTB43',
 'ZNF444']
overlap = [x for x in human if x in scplus_obj.uns['eRegulon_metadata']['TF'].unique()]
overlap
...
heatmap_dotplot(
        ...
        index_order = [ 'DA_neurons','DA_STN_neurons_immature','STN_neurons', 
                       ...
                       'MB_HB_FP_cells', 'Glial_progenitors_astrocytes', 'Low_quality_technical'][::-1],
        orientation = 'horizontal',
        save='/wynton/home/pollenlab/jding/Sara/scenicplus/figures/scenicplus/ChimpDev_heatmap_overlap.pdf')
...
plot_rss(scplus_obj, 'GEX_supervised_name_filtered', num_columns=3, top_n=20, figsize = (15, 30),save='/wynton/home/pollenlab/jding/Sara/scenicplus/figures/scenicplus/ChimpDev_rss.pdf')
...
selected_markers = list(set(flat_list(
    [scplus_obj.uns['RSS']['GEX_supervised_name_filtered'].loc[celltype].sort_values(ascending = False).head(10).index.to_list() 
    for celltype in scplus_obj.uns['RSS']['GEX_supervised_name_filtered'].index])))
...
nx_tables = create_nx_tables(
    ...
    differential_variable = ['ACC_condition']
)
...
G, pos, edge_tables, node_tables = create_nx_graph(nx_tables, 
                   ...
                   color_node_by = {'TF': {'variable': 'TF', 'category_color' : {genes[0]: 'Orange', 
                                    ...
                                    'Gene': {'variable': 'ACC_condition_Log2FC_Rot_72H', 'continuous_color' : 'bwr'},
                                    'Region': {'variable': 'ACC_condition_Log2FC_Rot_72H', 'continuous_color' : 'viridis'}},
                   transparency_node_by =  {'Region': {'variable' : 'ACC_condition_Log2FC_Rot_72H', 'min_alpha': 0.1},
                                    'Gene': {'variable' : 'ACC_condition_Log2FC_Rot_72H', 'min_alpha': 0.1}},
...
genes = ['ZBTB20', 'PHF21A','PBX3', 'KLF12']
...
from pycisTopic.diff_features import find_highly_variable_features
hvr = find_highly_variable_features(scplus_obj.to_df('ACC').loc[list(set(scplus_obj.uns['eRegulon_metadata_filtered']['Region']))], n_top_features=3500, plot = False)
hvg = find_highly_variable_features(scplus_obj.to_df('EXP')[list(set(scplus_obj.uns['eRegulon_metadata_filtered']['Gene']))].T, n_top_features=3500, plot = False)
...
adata.obs = scplus_obj.metadata_cell.astype(str)
