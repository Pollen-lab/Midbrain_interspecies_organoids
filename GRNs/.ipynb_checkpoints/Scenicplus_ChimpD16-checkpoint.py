...
import pandas as pd
adata.obs['index'] = [x.split('-')[0] + '-1' for x in adata.obs.index]
adata.obs['barcode'] = adata.obs['index'].astype(str) +'___'+ adata.obs['batch_name'].astype(str)
...
heatmap_dotplot(
        ...
        save='/wynton/home/pollenlab/jding/Sara/scenicplus/figures/scenicplus/ChimpD16_heatmap.svg')
...
print([x.split('_')[0] for x in scplus_obj.uns['eRegulon_signatures_filtered']['Gene_based'].keys()])


human=['ZNF496', 'MYC', 'ISL1', 'ATF7', 'FOXA2', 'ONECUT2', 'GLI3', 'VSX1', 'EN1', 'DRAP1', 'LIN28B', 'ZNF280D', 'ZBTB20', 'TWIST1', 'ELK3', 'NR2F2', 'MYBL2', 'ZEB1', 'TEAD1', 'SOX11', 'HMGA2', 'PBX3', 'TCF7L2', 'MXD3', 'TCF7L1', 'IKZF2', 'SMAD3', 'E2F8', 'NFE2L2', 'ZNF90', 'MEIS1', 'STAT3', 'SREBF2', 'ZBTB18', 'KLF12', 'BNC2', 'SOX13', 'LMX1A', 'IRF3', 'NEUROD1', 'MECOM', 'MSX1', 'ATF2', 'PRRX1', 'FOXM1', 'ZNF521', 'BACH1', 'RBPJ', 'ZNF141', 'SOX5', 'EBF1', 'RORA', 'NR2F1', 'ZNF367', 'BHLHE40', 'PITX2', 'FOXA1', 'NKX6-2', 'NFIA', 'CUX1', 'HBP1', 'ELF2', 'ARID5B', 'YBX1', 'SOX2', 'FOXP2', 'ZNF704', 'BBX', 'LEF1', 'ADNP', 'RFX4', 'NFE2L1', 'MYBL1', 'HSF1', 'TFDP2', 'ARX', 'JUND', 'E2F5', 'NCOA1', 'PAX8', 'EMX2', 'TCF4', 'REST', 'PKNOX2', 'ETV1', 'SOX6', 'HMBOX1', 'BACH2', 'GLI2', 'LMX1A', 'SOX4', 'YY1', 'CDC5L', 'CREB3L2', 'LCORL', 'RFX3', 'TCF12', 'ETV6', 'PBX1', 'POU3F2', 'JUN', 'EBF3', 'PAX5', 'E2F7', 'ATF4', 'KLF3', 'KLF7', 'ZNF385D', 'FOXN3', 'NKX6-1', 'SOX9', 'PHOX2B', 'STAT5B', 'UNCX', 'ZNF100', 'MEIS2', 'HES1', 'LHX4', 'LMX1B', 'ONECUT3', 'ZNF423', 'FOXJ3', 'NEUROD4', 'MAZ', 'CREM', 'FOXO3', 'HNF1B', 'TP53', 'OTX2', 'FOXP1', 'MTF2', 'ELF1', 'FOXO1', 'ARID3B', 'RFX2', 'ZNF462', 'CREB5', 'PLAGL1', 'ONECUT1', 'ATF3', 'GATA3', 'ZNF519', 'SMAD4', 'NKX2-1', 'ZNF93']
...
heatmap_dotplot(
        ...
        figsize = (20, 10),
        orientation = 'horizontal',
        save='/wynton/home/pollenlab/jding/Sara/scenicplus/figures/scenicplus/ChimpD16_heatmap_overlap.svg')
