...
import os
work_dir = '/wynton/group/pollen/jding/Sara/data/Chimp'
...
namesOfInterest=['D80_M_0-6_CNTRL_Chimp', 'D80_M_0-6_24H_Chimp', 'D80_M_0-8_24H_Chimp',
                 #'D80_M_0-6_72H_Chimp', 
                 'D80_M_0-8_72H_Chimp','D80_M_0-8_CNTRL_Chimp'
                ]
...
f = 'D80_M_0-6_72H_Chimp'
adata = sc.read_10x_h5(os.path.join('/wynton/group/pollen/jding/Sara/data/','filtered_feature_bc_matrix.h5'))
adata.uns['name']=f
print (adata.uns)
adata.obs['batch_name']=str(adata.uns['name'])
print (adata.obs)
...
fragments_dict = {'D80_M_0-6_24H_Chimp': '/wynton/group/pollen/sara_bam_d80_221216/D80_M_0-6_24H_Chimp/outs/atac_fragments.tsv.gz',
 'D80_M_0-6_72H_Chimp': '/wynton/group/pollen/sara_bam_d80_221216/D80_M_0-6_72H_Chimp/outs/atac_fragments.tsv.gz',
 'D80_M_0-6_CNTRL_Chimp': '/wynton/group/pollen/sara_bam_d80_221216/D80_M_0-6_CNTRL_Chimp/outs/atac_fragments.tsv.gz',
 'D80_M_0-8_24H_Chimp': '/wynton/group/pollen/sara_bam_d80_221216/D80_M_0-8_24H_Chimp/outs/atac_fragments.tsv.gz',
 'D80_M_0-8_72H_Chimp': '/wynton/group/pollen/sara_bam_d80_221216/D80_M_0-8_72H_Chimp/outs/atac_fragments.tsv.gz',
...
import pandas as pd
import scanpy as sc
adata = sc.read(os.path.join(work_dir, 'scRNA/adata.h5ad'))
cell_data = adata.obs
...
path_to_regions = {'D80_M_0-6_24H_Chimp': '/wynton/group/pollen/jding/Sara/data/Chimp/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D80_M_0-6_72H_Chimp': '/wynton/group/pollen/jding/Sara/data/Chimp/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D80_M_0-6_CNTRL_Chimp': '/wynton/group/pollen/jding/Sara/data/Chimp/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D80_M_0-8_24H_Chimp': '/wynton/group/pollen/jding/Sara/data/Chimp/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D80_M_0-8_72H_Chimp': '/wynton/group/pollen/jding/Sara/data/Chimp/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D80_M_0-8_CNTRL_Chimp': '/wynton/group/pollen/jding/Sara/data/Chimp/scATAC/consensus_peak_calling/consensus_regions.bed'}
...
qc_filters={'D80_M_0-6_24H_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [3.5, None],
  'Dupl_rate': [None, None]},
 'D80_M_0-6_72H_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [3.5, None],
  'Dupl_rate': [None, None]},
 'D80_M_0-6_CNTRL_Chimp': {'Log_unique_nr_frag': [3, None],
  ...
  'TSS_enrichment': [3.5, None],
  'Dupl_rate': [None, None]},
 'D80_M_0-8_24H_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [3.5, None],
  'Dupl_rate': [None, None]},
 'D80_M_0-8_72H_Chimp': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [3.5, None],
  'Dupl_rate': [None, None]},
...
index = cistopic_obj.cell_data.leiden.dropna().index.tolist()
...
fpath = "/wynton/group/pollen/jding/Sara/data/Chimp/scATAC/"
...
#remove low count clusters: Mixed_neurons_(macaque)                   
#index=scplus_obj.metadata_cell[scplus_obj.metadata_cell.ACC_supervised_name.isin([
#       'Glutamatergic_neurons_stressed','MB_HB_glutamatergic_neurons',              
#'MB_HB_neurons_LHX1+', 'Stressed_neurons_low_quality',             
#'Dopaminergic_neurons', 'FB_MB_glutamatergic_neurons',              
#'Stressed_neurons' , 'MB_HB_glutamatergic_neurons_stressed',     
#'Progenitor_cells', 'MB_GABAergic_neurons' ,                    
#'Dopaminergic_neurons_stressed' , 'Serotonergic_neurons', 'Oculomotor_neurons' ])].index.tolist()
...
scplus_obj.uns['eRegulon_metadata'][scplus_obj.uns['eRegulon_metadata']['TF'] == 'SOX4'].sort_values(by = 'TF2G_rho', ascending=False).Gene.head(1000).unique()
...
scplus_obj.metadata_cell['GEX_leiden'].unique()
...
plot_rss(scplus_obj, 'GEX_leiden_filtered', num_columns=3, top_n=20, figsize = (20, 10))
...
selected_markers = list(set(flat_list(
    ...
    for celltype in scplus_obj.uns['RSS']['GEX_leiden_filtered'].index])))
