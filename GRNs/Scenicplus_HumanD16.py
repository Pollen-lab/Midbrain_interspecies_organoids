...
import os
work_dir = '/wynton/group/pollen/jding/Sara/data/HumanD16'
...
fragments_dict={'D16_CH2_Human': '/wynton/group/pollen/sara_bam_timepoint1/CH2_Human/outs/atac_fragments.tsv.gz',
 'D16_CH_Human': '/wynton/group/pollen/sara_bam_timepoint1/CH_Human/outs/atac_fragments.tsv.gz',
 'D16_M0_5_Human': '/wynton/group/pollen/sara_bam_timepoint1/M0_5_Human/outs/atac_fragments.tsv.gz',
 'D16_M2_Human': '/wynton/group/pollen/sara_bam_timepoint1/M2_Human/outs/atac_fragments.tsv.gz',
 'D16_M_Human': '/wynton/group/pollen/sara_bam_timepoint1/M_Human/outs/atac_fragments.tsv.gz',
 'D16_outgroup-exp_Human': '/wynton/group/pollen/sara_bam_230211_outgroup/D16_outgroup-exp_Human/outs/atac_fragments.tsv.gz'}
...
path_to_regions={'D16_CH2_Human': '/wynton/group/pollen/jding/Sara/data/HumanD16/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D16_CH_Human': '/wynton/group/pollen/jding/Sara/data/HumanD16/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D16_M0_5_Human': '/wynton/group/pollen/jding/Sara/data/HumanD16/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D16_M2_Human': '/wynton/group/pollen/jding/Sara/data/HumanD16/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D16_M_Human': '/wynton/group/pollen/jding/Sara/data/HumanD16/scATAC/consensus_peak_calling/consensus_regions.bed',
 'D16_outgroup-exp_Human': '/wynton/group/pollen/jding/Sara/data/HumanD16/scATAC/consensus_peak_calling/consensus_regions.bed'}
...
qc_filters={'D16_CH2_Human': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D16_CH_Human': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D16_M0_5_Human': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D16_M2_Human': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D16_M_Human': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]},
 'D16_outgroup-exp_Human': {'Log_unique_nr_frag': [3, None],
  'FRIP': [0.2, None],
  'TSS_enrichment': [4, None],
  'Dupl_rate': [None, None]}}
...
cistopic_obj.fragment_matrix.todense().shape
...
#path = "/wynton/group/pollen/jding/Sara/data/HumanDev/scATAC/"
fpath = "/wynton/group/pollen/jding/Sara/data/HumanD16/scATAC/"
...
heatmap_dotplot(
        ...
        save='/wynton/home/pollenlab/jding/Sara/scenicplus/figures/scenicplus/HumanD16_heatmap.svg')
...
heatmap_dotplot(
        ...
        figsize = (15, 10),
        orientation = 'horizontal',
        save='/wynton/home/pollenlab/jding/Sara/scenicplus/figures/scenicplus/HumanD16_heatmap.pdf')

print([x.split('_')[0] for x in scplus_obj.uns['eRegulon_signatures_filtered']['Gene_based'].keys()])


chimp=['ATF2', 'TCF12', 'HMGA1', 'MXD3', 'IKZF2', 'ZNF521', 'HES4', 'CREB3L1', 'ZNF462', 'RFX2', 'HES1', 'FOXM1', 'SOX5', 'MAX', 'TAL2', 'PBX3', 'OTX2', 'SREBF2', 'ZNF90', 'SMAD4', 'NFE2L2', 'SOX6', 'CREB5', 'NFYB', 'PBX1', 'RFX3', 'KLF3', 'TCF7L1', 'E2F7', 'NEUROD4', 'EBF3', 'LHX1', 'TCF7L2', 'XBP1', 'EGR1', 'MYBL2', 'STAT1', 'HMBOX1', 'NKX2-1', 'YY1', 'FOXA1', 'TCF7L1', 'RXRG', 'ELF2', 'MTF2', 'ONECUT2', 'SOX11', 'CEBPZ', 'EBF1', 'POU3F1', 'LCORL', 'RFX3', 'PITX2', 'FOXP2', 'NKX6-2', 'SOX2', 'ZEB2', 'MYBL1', 'CUX1', 'ZNF518A', 'MEIS2', 'ATF4', 'ARID3A', 'MEIS1', 'AHDC1', 'JUND', 'HMGA2', 'NKX6-1', 'NHLH2', 'NEUROG1', 'MAFG', 'LMX1B', 'TEAD1', 'MEF2A', 'JUN', 'EN2', 'ZNF519', 'FOXA2', 'RFX7', 'TFDP2', 'ZBTB18', 'LMX1A', 'POU3F2', 'ZBTB21', 'YBX1', 'ZNF483', 'ONECUT3', 'EN1', 'UNCX', 'NFYC', 'TFDP1', 'VEZF1', 'MEIS1', 'ARX', 'ZEB1', 'STAT3', 'CREM', 'NFIA', 'ZNF367', 'SP4', 'ARID5B', 'ZNF217', 'PAX8', 'PHOX2B', 'RFX4', 'BACH2', 'ZNF423', 'ZNF644', 'SOX4', 'ISL1', 'LEF1', 'FOXJ3', 'LHX2', 'PAX5', 'NR2F2', 'ATF3', 'PLAGL1']
...
heatmap_dotplot(
        ...
        figsize = (20, 10),
        orientation = 'horizontal',
        save='/wynton/home/pollenlab/jding/Sara/scenicplus/figures/scenicplus/HumanD16_heatmap_overlap.svg')
...
heatmap_dotplot(
        ...
        figsize = (20, 10),
        orientation = 'horizontal',
        save='/wynton/home/pollenlab/jding/Sara/scenicplus/figures/scenicplus/HumanD16_heatmap_overlap.pdf')
...
plot_rss(scplus_obj, 'GEX_supervised_name_filtered', num_columns=3, top_n=20, figsize = (15, 30),save='/wynton/home/pollenlab/jding/Sara/scenicplus/figures/scenicplus/HumanD16_rss.pdf')
...
region_intersetc_data, Z = jaccard_heatmap(
        ...
        save='/wynton/home/pollenlab/jding/Sara/scenicplus/figures/scenicplus/HumanD16_intersect.pdf')
...
hvg.extend(df[df['TF'].str.contains('NR4A2')]['Gene'].to_list())
hvr.extend(df[df['TF'].str.contains('NR4A2')]['Region'].to_list())
...
G, pos, edge_tables, node_tables = create_nx_graph(nx_tables, 
                   ...
                   color_node_by = {'TF': {'variable': 'TF', 'category_color' : {genes[0]: 'Orange', 
                                    ...
                                    'Gene': {'variable': 'ACC_cell_type_Log2FC_DA_neurons', 'continuous_color' : 'bwr'},
                                    'Region': {'variable': 'ACC_cell_type_Log2FC_DA_neurons', 'continuous_color' : 'viridis'}},
                   transparency_node_by =  {'Region': {'variable' : 'ACC_cell_type_Log2FC_DA_neurons', 'min_alpha': 0.1},
                                    'Gene': {'variable' : 'ACC_cell_type_Log2FC_DA_neurons', 'min_alpha': 0.1}},
